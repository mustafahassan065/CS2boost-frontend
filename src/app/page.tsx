...
{/* LEFT side stack — Gabriel image + Loyalty Program (rewards table) */}
{/* LEFT side stack — Gabriel image + Loyalty Program (rewards table) */}
<div className="pointer-events-none absolute left-14 top-14 z-30 hidden w-[240px] flex-col gap-8 xl:flex 2xl:left-24 2xl:w-[300px]">
...
<div className="pointer-events-none absolute right-14 top-14 z-30 hidden w-[240px] flex-col gap-8 xl:flex 2xl:right-24 2xl:w-[300px]">
  <Image src="/images/gabriel-sleiter.jpg" alt="" width={958} height={539} className="w-full opacity-80" />
